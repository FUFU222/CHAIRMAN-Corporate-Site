...
> **この文書は歴史的記録です。** 本番切替（`/preview/` → 本番ルート）は既に完了しています
> （関連コミット: `77f2327`, `642846c`）。日常のデプロイ・ロールバック手順は現行の正本
> [../../docs/RUNBOOKS.md](../../docs/RUNBOOKS.md) と [../../docs/TRIBAL-KNOWLEDGE.md](../../docs/TRIBAL-KNOWLEDGE.md)
> を参照してください。以下は切替当日の判断根拠・手順の記録として残しています。
