...
class CLogin
{
    ...
    public function Login()
    {
        ...
        if (isset($_SESSION['ID']) && isset($_SESSION['PASSTYPE']) && isset($_SESSION['PASSWORD'])) {
            if ($_SESSION['ID'] == ID) {
                if ($_SESSION['PASSTYPE'] == 'PASSWORD' && $_SESSION['PASSWORD'] == PASSWORD) {
                    return true;
                }
                if ($_SESSION['PASSTYPE'] == 'PASSWORD2' && $_SESSION['PASSWORD'] == PASSWORD2) {
                    return true;
                }
            }
        }
        ...
        if (isset($_POST['username']) && isset($_POST['password'])) {
            ...
            if ($_POST['username'] == ID && md5($_POST['password']) == PASSWORD) {
                $passtype = 'PASSWORD';
            }
            if ($_POST['username'] == ID && md5($_POST['password']) == PASSWORD2) {
                $passtype = 'PASSWORD2';
            }
